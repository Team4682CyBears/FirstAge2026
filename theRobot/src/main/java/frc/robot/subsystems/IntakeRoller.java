...
public class IntakeRoller extends SubsystemBase {
    ...
    private TalonFX IntakeLeadTalonFX = new TalonFX(Constants.kickerLeadTalonCanId);
    private TalonFX IntakeFollowTalonFX = new TalonFX(Constants.kickerFollowTalonCanId);
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Kicker Follow Real RPM", IntakeFollowTalonFX.getVelocity().getValueAsDouble() * 60);
    }
