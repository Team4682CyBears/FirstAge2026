...
class TurretTest {
  ...
  void SmallNegativeAngleClampsToMin(){
    ...
    turret.setTargetAngleRadians(targetRadians);
    assertEquals(Units.degreesToRadians(Constants.turretMinAngleDegrees), turret.getTurretMechanismAngleRadians(), DELTA);
  }
  ...
  void SmallNegativeAngleClampsToMax(){
    ...
    turret.setTargetAngleRadians(targetRadians);
    assertEquals(Units.degreesToRadians(Constants.turretMaxAngleDegrees), turret.getTurretMechanismAngleRadians(), DELTA);
  }
  ...
  void LargePositiveAngleWraps(){
    ...
    turret.setTargetAngleRadians(targetRadians);
    assertEquals(0.1, turret.getTurretMechanismAngleRadians(), DELTA);
  }
  ...
  void LargeNegativeAngleWraps(){
    ...
    turret.setTargetAngleRadians(targetRadians);
    assertEquals(1.0, turret.getTurretMechanismAngleRadians(), DELTA);
  }
}